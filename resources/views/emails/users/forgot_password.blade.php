                                  ...
                                  <td><table width="560" align="center" cellpadding="0" cellspacing="0" border="0" class="devicewidthinner">
                                      ...
                                      <tr>
                                         ...
                                         <tr>
                                                    ...
                                                    <a href="{{ config('variable.SERVER_URL') }}/reset-password/{{ $user->forgot_password_token}}" style="color: #90cbf5;">Reset Password</a>
                                                    </td>
                                                </tr>
                                  ...
                                  <td><table width="560" align="center" cellpadding="0" cellspacing="0" border="0" class="devicewidthinner">
                                      ...
                                      <tr>
                                          <td style="font-family: Open Sans,open-sans,sans-serif; font-size:14px; line-height:22px; vertical-align: top; color:#7a2a90; ">
                                              <a style="color:#7a2a90" href="{{ config('variable.SERVER_URL') }}/reset-password/{{ $user->forgot_password_token}}">{{ config('variable.SERVER_URL') }}/reset-password/{{ $user->forgot_password_token}}</a>
                                          </td>
                                        </tr>
                                      <tr>
